...
```text
https://raw.githubusercontent.com/KingCrimsonD/ainol-octo-cli-exam-issues/main/agents/agent-a-product-steward.md
```
...
```text
https://raw.githubusercontent.com/KingCrimsonD/ainol-octo-cli-exam-issues/main/agents/agent-b-pm-reviewer.md
```
...
KNOWLEDGE_BASE_REPO=https://github.com/KingCrimsonD/ainol-octo-cli-exam-issues
```
